...
while  numberoflinks<1:
    link=ws.extract_link_revista22('http://www.revista22.ro/autor-gabriel-liiceanu-1',numberoflinks)
    ...
    if ws.article_exists(title,summary,6) == False:
        ...
        db = client[DB]
        db['article'].insert({"date_ttl":datetime.utcnow(),"authId":int(6),"authName":"Gabriel Liiceanu",
                              ...
                              "authImgUrl" : "https://ws-truthrevolution.rhcloud.com/images/v1/gabriel-liiceanu.png",
                              "artSentiment":int(sentiment),"comments":[],"artSource":"revista22.ro",
                              "artCategory":artCategory})
    numberoflinks=numberoflinks+1

ws.update_articlelistversion(update_returnArticlesListVersion,6)
