...
d = feedparser.parse('http://topics.nytimes.com/top/reference/timestopics/people/s/david_streitfeld/index.html?rss=1')
...
for post in d.entries:
    if ws.article_freshness(post.published_parsed,3600) is True:
        if ws.article_exists(post.title,BeautifulSoup(post.summary).get_text(),24) == False:
            ...
            db = client[DB]
            db['article'].insert({"date_ttl":datetime.utcnow(),"authId":int(24),"authName":"David Streitfeld",
                                  ...
                                  "authImgUrl" : "https://ws-truthrevolution.rhcloud.com/images/v1/david-streitfeld.png",
                                  "artSentiment":int(sentiment),"comments":[],"artSource":"nytimes.com",
                                  "artCategory":artCategory})

ws.update_articlelistversion(update_returnArticlesListVersion,24)
